...
namespace MagazijnProject.Forms
{
    public partial class OrderCreation : Form
    {
        ...
        public OrderCreation(Employee loggedInEmployee, Customer selectedCustomer)
        {
            InitializeComponent();
            CenterToScreen();
        ...
        public OrderCreation(Employee loggedInEmployee, Order selectedOrder)
        {
            InitializeComponent();
            CenterToScreen();
            _loggedInEmployee = loggedInEmployee;
        ...
        public OrderCreation(Employee loggedInEmployee, Supplier selectedSupplier)
        {
            InitializeComponent();
            CenterToScreen();
            _loggedInEmployee = loggedInEmployee;
        ...
        public OrderCreation(Employee loggedInEmployee, Customer selectedCustomer, Order selectedOrder)
        {
            InitializeComponent();
            CenterToScreen();
            _loggedInEmployee = loggedInEmployee;
        ...
        public OrderCreation(Employee loggedInEmployee, Supplier selectedSupplier, Order selectedOrder)
        {
            InitializeComponent();
            CenterToScreen();
            _loggedInEmployee = loggedInEmployee;
